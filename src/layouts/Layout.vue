...
<!--          <div>-->
<!--&lt;!&ndash;            <q-img&ndash;&gt;-->
<!--&lt;!&ndash;              style="height:50px; width:70px; cursor: pointer;"&ndash;&gt;-->
<!--&lt;!&ndash;              src="../statics/icons/HonoluluBakingLogoBlackWhite.png"&ndash;&gt;-->
<!--&lt;!&ndash;              @click="teleport('#opening-screen')"&ndash;&gt;-->
<!--&lt;!&ndash;            />&ndash;&gt;-->
<!--&lt;!&ndash;            TODO await opinions from the baking comp&ndash;&gt;-->
<!--            &lt;!&ndash;            height:200px; width: 300px; &ndash;&gt;-->
<!--            <q-img-->
<!--              style="height:48px; width:70px; cursor: pointer;"-->
